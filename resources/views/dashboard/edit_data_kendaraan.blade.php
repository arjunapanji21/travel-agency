...
<div>
    ...
    <form action="{{route('update_data_kendaraan', $kendaraan->id)}}" method="post">
        @csrf
        <div class="border-b border-gray-900/10 pb-12">
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" required value="{{$kendaraan->nama}}" name="nama" id="nama"
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" required value="{{$kendaraan->jenis}}" name="jenis" id="jenis"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input id="nopol" required value="{{$kendaraan->nopol}}" name="nopol" type="text"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input id="max_penumpang" required value="{{$kendaraan->max_penumpang}}" name="max_penumpang" type="number"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
